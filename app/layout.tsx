...
export const metadata: Metadata = {
  title: {
    default: 'Hackathon in Vancouver 2026 | Equinox Vancouver Hackathon – Free for Teens',
    template: '%s | Equinox Vancouver Hackathon',
  },
  description: 'Register for Equinox Vancouver Hackathon 2026 — Vancouver\'s premier free beginner-friendly hackathon for high school students and teenagers. Build projects, learn to code, attend workshops, and make lifelong friends. March 7, 2026 in Vancouver, BC.',
  keywords: [
  ...
  openGraph: {
    ...
    title: 'Hackathon in Vancouver 2026 | Equinox Vancouver Hackathon – Register Now',
