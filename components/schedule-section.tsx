...
const schedule = [
  ...
  { time: "10:45 AM", event: "Workshop: Intro to Web Dev", highlight: false },
  { time: "12:00 PM", event: "Lunch (Free!)", highlight: false },
  { time: "12:45 PM", event: "Workshop: Building with AI", highlight: false },
  { time: "2:00 PM", event: "Mini Activity & Snack Break", highlight: false },
  { time: "2:20 PM", event: "Workshop: Game Dev Basics", highlight: false },
  { time: "3:30 PM", event: "Dinner (Free!)", highlight: false },
  { time: "4:00 PM", event: "Final Hacking Sprint", highlight: true },
  { time: "5:30 PM", event: "Project Demos", highlight: true },
  { time: "6:15 PM", event: "Awards & Closing Ceremony", highlight: true },
  { time: "6:30 PM", event: "Event Ends", highlight: false },
]
